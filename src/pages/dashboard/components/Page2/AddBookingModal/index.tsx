  ...
  return (
    ...
    >
      <Form
        ...
        layout="vertical"
        initialValues={{
          vehicleId: defaultVehicle !== "all" ? defaultVehicle : undefined,
        }}
        style={{ padding: "8px 0" }}
      >
        <Row gutter={12}>
        ...
        <Row gutter={12}>
          ...
          <Col xs={24} md={12}>
            <Form.Item
              name="seatCount"
              label={
                <span style={{ color: "#94a3b8", fontSize: 12 }}>Số ghế</span>
              }
        ...
        <Row gutter={12}>
          <Col xs={24} md={12}>
            <Form.Item
              name="pickup"
              label={
                <span style={{ color: "#94a3b8", fontSize: 12 }}>Điểm đón</span>
              }
            >
          ...
          <Col xs={24} md={12}>
            <Form.Item
              name="dropoff"
              label={
                <span style={{ color: "#94a3b8", fontSize: 12 }}>Điểm trả</span>
              }
            >
        ...
        <Form.Item
          name="note"
          label={
            <span style={{ color: "#94a3b8", fontSize: 12 }}>Ghi chú</span>
          }
        >
          <Input.TextArea
            rows={3}
