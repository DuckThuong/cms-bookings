...
const CustomersPage = () => {
  ...
  const columns: ColumnsType<CustomerRecord> = [
    ...
    },
    {
      ...
      dataIndex: "tier",
      key: "tier",
      render: (value: CustomerRecord["tier"]) => (
    ...
    <div className="mgmt-page">
      <div className="mgmt-hero">
        ...
        <div className="mgmt-hero__subtitle">
          Theo dõi nhóm khách giá trị cao, khách suy giảm tần suất và lịch sử
          giao dịch gần đây.
        </div>
      </div>
            ...
            <Table
              ...
              locale={{
                emptyText: listQuery.isError ? (
                  <Empty description="Không tải được danh sách khách hàng" />
                ) : (
                  <Empty description="Chưa có khách hàng" />
                ),
              }}
                ...
                {selected.recentTrips.length > 0 ? (
                  selected.recentTrips.map((trip) => (
                    <div className="mgmt-activity__item" key={trip.id}>
                      ...
                      <div className="mgmt-activity__amount">
