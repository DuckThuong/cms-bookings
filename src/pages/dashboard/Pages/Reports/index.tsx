...
export const renderReportStatus = (value: CmsReportItem["status"]) => {
    ...
    () => [
      { title: "Báo cáo", key: "name", render: (_, record) => (
        <div>
          ...
          <div className="report-subtitle">{REPORT_TYPE_LABEL[record.type]} · {record.period}</div>
        </div>
      )},
      ...
      { title: "Trạng thái", dataIndex: "status", key: "status", render: renderReportStatus },
          ...
          <div className="drawer-body">
            <div className="drawer-body__section">
              ...
              <div className="mgmt-detail-list">
                <div className="mgmt-detail-list__item"><span className="mgmt-detail-list__label">Loại</span><span className="mgmt-detail-list__value">{REPORT_TYPE_LABEL[selected.type]}</span></div>
