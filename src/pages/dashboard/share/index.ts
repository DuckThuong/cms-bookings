...
// Bảng màu thống nhất với color.scss ($status-*, $accent-orange)
...
export const statCards = [
  ...
  export const recentActivities = [
    ...
    { id: 3, name: 'Trần Thị Bảo', initials: 'TB', desc: 'Huỷ đặt vé #BK-20475', time: '28 phút trước', dot: STATUS_COLORS.cancelled },
